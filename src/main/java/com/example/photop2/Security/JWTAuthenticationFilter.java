...
import static com.example.photop2.Security.SecurityConstants.EXPIRATION_TIME;
import static com.example.photop2.Security.SecurityConstants.HEADER_STRING;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            ...
            user=usersService.getUserbyLogin(creds.getLogin());
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String token = JWT.create()
                ...
                .withClaim("moderator",user.isModerator())
